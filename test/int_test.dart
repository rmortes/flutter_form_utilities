...
void main() {
  group("Int validation", () {
    test("Rejects not int", () {
      final validator = validate([AsInt().eq(32)]);
    ...
    test("Gt works", () {
      final validator = validate([AsInt().gt(32)]);
    ...
    test("Is not valid works", () {
      final validator = validate([AsInt().isNotValid()]);
